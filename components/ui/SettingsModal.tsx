...
import { useSettingsStore, VegetationDensity, AOQuality, TimeOfDayMode } from '@/lib/store/useSettingsStore'
...
export const SettingsModal = ({ isOpen, onClose }: SettingsModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 bg-opacity-60 backdrop-blur-sm">
            <div className="bg-zinc-800 border border-zinc-700 rounded-lg shadow-lg w-full max-w-sm text-white">
                ...
                <div className="p-4 divide-y divide-zinc-700">
                    ...
                    <SettingRow label="Render Grass & Flowers (High GPU usage)">
                        <input
                            type="checkbox"
                    ...
                    <SettingRow label="Vegetation Density">
                        <Select
